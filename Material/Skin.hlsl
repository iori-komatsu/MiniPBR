...
float _SpecularSmoothness        : CONTROLOBJECT < string name="SkinController.pmx"; string item="îΩéÀåıÇÃääÇÁÇ©Ç≥"; >;
float _DiffuseSmoothness         : CONTROLOBJECT < string name="SkinController.pmx"; string item="ägéUåıÇÃääÇÁÇ©Ç≥"; >;
float _ReduceShadow              : CONTROLOBJECT < string name="SkinController.pmx"; string item="âeÇîñÇﬂÇÈ"; >;
float _SubsurfaceScatteringScale : CONTROLOBJECT < string name="SkinController.pmx"; string item="îÁâ∫éUóê"; >;
